...
<meta content="SegC-V01/src/communication/OpCode.java · 602b6ba877c4293e120ec4993800e9d2928d6094 · João David / SegC-P1" property="og:title">
...
<meta content="https://git.alunos.di.fc.ul.pt/fc49448/segc-p1/blob/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/communication/OpCode.java" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="SegC-V01/src/communication/OpCode.java · 602b6ba877c4293e120ec4993800e9d2928d6094 · João David / SegC-P1" property="twitter:title">
...
<title>SegC-V01/src/communication/OpCode.java · 602b6ba877c4293e120ec4993800e9d2928d6094 · João David / SegC-P1 · GitLab</title>
...
<meta name="csrf-token" content="9M3Gol2P0AOg/OXqTR7Vp6ch2cL/NoqnmMDCR3nYiH4qx3AqZ3G0433f7FfWeniXCgp/SEXCdV28BEqaKNqDaw==" />
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/fc49448/segc-p1/blob/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/communication/OpCode.java">Repository</a></h2>
</li>
</ul>
</div>
...
<div class="js-signature-container" data-signatures-path="/fc49448/segc-p1/commits/34d941ac08f4d2f53c3a5461fd957e801c7601f3/signatures"></div>
...
<input type="hidden" name="path" id="path" value="SegC-V01/src/communication/OpCode.java" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/fc49448/segc-p1/tree/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/communication">communication</a>
</li>
<li class="breadcrumb-item">
<a href="/fc49448/segc-p1/blob/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/communication/OpCode.java"><strong>OpCode.java</strong>
</a></li>
</ul>
</div>
...
<div class="btn-group" role="group"><a class="btn js-blob-blame-link" href="/fc49448/segc-p1/blame/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/communication/OpCode.java">Blame</a><a class="btn" href="/fc49448/segc-p1/commits/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/communication/OpCode.java">History</a><a class="btn js-data-file-blob-permalink-url" href="/fc49448/segc-p1/blob/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/communication/OpCode.java">Permalink</a></div>
</div>
</div>
...
<li class="commit flex-row js-toggle-container" id="commit-34d941ac">
<div class="avatar-cell d-none d-sm-block">
<a href="/fc49448"><img alt="João David&#39;s avatar" src="/uploads/-/system/user/avatar/438/avatar.png?width=36" class="avatar s36 d-none d-sm-inline" title="João David" /></a>
</div>
<div class="commit-detail flex-list">
<div class="commit-content qa-commit-content">
<a class="commit-row-message item-title" href="/fc49448/segc-p1/commit/34d941ac08f4d2f53c3a5461fd957e801c7601f3">collect bugfix</a>
...
<div class="committer">
<a class="commit-author-link js-user-link" data-user-id="438" href="/fc49448">João David</a> authored <time class="js-timeago" title="Mar 10, 2019 12:47pm" datetime="2019-03-10T12:47:35Z" data-toggle="tooltip" data-placement="bottom" data-container="body">Mar 10, 2019</time>
</div>
<pre class="commit-row-description js-toggle-content append-bottom-8">&#x000A;friends function was not checking the right user's trusted file&#x000A;ERR_NOT_FRIENDS changed to ERR_NOT_TRUSTED&#x000A;updated exel and word</pre>
</div>
<div class="commit-actions flex-row d-none d-sm-flex">

<div class="js-commit-pipeline-status" data-endpoint="/fc49448/segc-p1/commit/34d941ac08f4d2f53c3a5461fd957e801c7601f3/pipelines?ref=602b6ba877c4293e120ec4993800e9d2928d6094"></div>
<div class="commit-sha-group">
<div class="label label-monospace">
34d941ac
</div>
<button class="btn btn btn-default" data-toggle="tooltip" data-placement="bottom" data-container="body" data-title="Copy commit SHA to clipboard" data-class="btn btn-default" data-clipboard-text="34d941ac08f4d2f53c3a5461fd957e801c7601f3" type="button" title="Copy commit SHA to clipboard" aria-label="Copy commit SHA to clipboard"><svg><use xlink:href="/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#duplicate"></use></svg></button>
...
<button class="btn btn-clipboard btn-transparent prepend-left-5" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent prepend-left-5" data-title="Copy file path to clipboard" data-clipboard-text="{&quot;text&quot;:&quot;SegC-V01/src/communication/OpCode.java&quot;,&quot;gfm&quot;:&quot;`SegC-V01/src/communication/OpCode.java`&quot;}" type="button" title="Copy file path to clipboard" aria-label="Copy file path to clipboard"><svg><use xlink:href="/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#duplicate"></use></svg></button>
<small>
765 Bytes
</small>
</div>
...
<div class="btn-group" role="group"><button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy source to clipboard" data-clipboard-target=".blob-content[data-blob-id=&#39;54606aaa2424f5f599e7e6ea5a305518bd2419cc&#39;]" type="button" title="Copy source to clipboard" aria-label="Copy source to clipboard"><svg><use xlink:href="/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#duplicate"></use></svg></button><a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Open raw" data-container="body" href="/fc49448/segc-p1/raw/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/communication/OpCode.java"><i aria-hidden="true" data-hidden="true" class="fa fa-file-code-o"></i></a><a download="SegC-V01/src/communication/OpCode.java" class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" title="Download" data-container="body" href="/fc49448/segc-p1/raw/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/communication/OpCode.java?inline=false"><svg><use xlink:href="/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#download"></use></svg></a></div>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-success" rel="nofollow" data-method="post" href="/fc49448/segc-p1/blob/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/communication/OpCode.java">Fork</a>
...
<div class="blob-viewer" data-type="simple" data-url="/fc49448/segc-p1/blob/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/communication/OpCode.java?format=json&amp;viewer=simple">
...
<h3 class="page-title">Replace OpCode.java</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/fc49448/segc-p1/update/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/communication/OpCode.java" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="zjjb3WDFAX+3HZIw7p1HbWX9etwf8o3Zh4EZR7kDJSoQMm1VWjtln2o+m411+epdyNbcVqUGciOjRZGa6AEuPw==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-582136b7d96305975e18ee76d9f9bfc7">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-582136b7d96305975e18ee76d9f9bfc7" class="form-control js-commit-message" placeholder="Replace OpCode.java" required="required" rows="3">
Replace OpCode.java</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-9e9ba34baac9ae005a3a1719ae786044" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-9e9ba34baac9ae005a3a1719ae786044">Start a <strong>new merge request</strong> with these changes
</label></div>
