...
<meta content="SegC-V01/src/server/Manager.java · 602b6ba877c4293e120ec4993800e9d2928d6094 · João David / SegC-P1" property="og:title">
...
<meta content="https://git.alunos.di.fc.ul.pt/fc49448/segc-p1/blob/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/server/Manager.java" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="SegC-V01/src/server/Manager.java · 602b6ba877c4293e120ec4993800e9d2928d6094 · João David / SegC-P1" property="twitter:title">
...
<title>SegC-V01/src/server/Manager.java · 602b6ba877c4293e120ec4993800e9d2928d6094 · João David / SegC-P1 · GitLab</title>
...
<meta name="csrf-token" content="hcZ7/8nHrXAN1NPumTBGXyHj0jPS2fZqlZBzZuyuKCRbzM138znJkND32lMCVOtvjMh0uWgtCZCxVPu7vawjMQ==" />
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/fc49448/segc-p1/blob/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/server/Manager.java">Repository</a></h2>
</li>
</ul>
</div>
...
<div class="js-signature-container" data-signatures-path="/fc49448/segc-p1/commits/36703c004908594356f11bb01704e4d1c13f61d1/signatures"></div>
...
<input type="hidden" name="path" id="path" value="SegC-V01/src/server/Manager.java" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/fc49448/segc-p1/blob/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/server/Manager.java"><strong>Manager.java</strong>
</a></li>
</ul>
</div>
...
<div class="btn-group" role="group"><a class="btn js-blob-blame-link" href="/fc49448/segc-p1/blame/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/server/Manager.java">Blame</a><a class="btn" href="/fc49448/segc-p1/commits/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/server/Manager.java">History</a><a class="btn js-data-file-blob-permalink-url" href="/fc49448/segc-p1/blob/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/server/Manager.java">Permalink</a></div>
</div>
</div>
...
<li class="commit flex-row js-toggle-container" id="commit-36703c00">
...
<a class="commit-row-message item-title" href="/fc49448/segc-p1/commit/36703c004908594356f11bb01704e4d1c13f61d1">otimização dos LOCKS</a>
<span class="commit-row-message d-block d-sm-none">
&middot;
36703c00
</span>
<div class="committer">
<a class="commit-author-link js-user-link" data-user-id="407" href="/fc49038">João Miguel Antunes Marques</a> authored <time class="js-timeago" title="Mar 11, 2019 9:06pm" datetime="2019-03-11T21:06:36Z" data-toggle="tooltip" data-placement="bottom" data-container="body">Mar 11, 2019</time>
</div>
</div>
<div class="commit-actions flex-row d-none d-sm-flex">

<div class="js-commit-pipeline-status" data-endpoint="/fc49448/segc-p1/commit/36703c004908594356f11bb01704e4d1c13f61d1/pipelines?ref=602b6ba877c4293e120ec4993800e9d2928d6094"></div>
<div class="commit-sha-group">
<div class="label label-monospace">
36703c00
</div>
<button class="btn btn btn-default" data-toggle="tooltip" data-placement="bottom" data-container="body" data-title="Copy commit SHA to clipboard" data-class="btn btn-default" data-clipboard-text="36703c004908594356f11bb01704e4d1c13f61d1" type="button" title="Copy commit SHA to clipboard" aria-label="Copy commit SHA to clipboard"><svg><use xlink:href="/assets/icons-24aaa921aa9e411162e6913688816c79861d0de4bee876cf6fc4c794be34ee91.svg#duplicate"></use></svg></button>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-success" rel="nofollow" data-method="post" href="/fc49448/segc-p1/blob/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/server/Manager.java">Fork</a>
...
<div class="blob-viewer" data-type="simple" data-url="/fc49448/segc-p1/blob/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/server/Manager.java?format=json&amp;viewer=simple">
...
<h3 class="page-title">Replace Manager.java</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/fc49448/segc-p1/update/602b6ba877c4293e120ec4993800e9d2928d6094/SegC-V01/src/server/Manager.java" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="EGxTR5xv/PM10Pw9oCHq83JS1p5fsjGmrOsCB4SV9MfOZuXPppGYE+jz9YA7RUfD33lwFOVGzlyIL4ra1Zf/0g==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-f88809a943768299fc1b819a174e0f8a">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-f88809a943768299fc1b819a174e0f8a" class="form-control js-commit-message" placeholder="Replace Manager.java" required="required" rows="3">
Replace Manager.java</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-6fedf465543bf1a7ba70279de9a6a94f" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-6fedf465543bf1a7ba70279de9a6a94f">Start a <strong>new merge request</strong> with these changes
</label></div>
